...
@php
    $total_pengajuan = $jumlah_pencairan + $total_pencairan_proses + $total_pencairan_ditolak;
@endphp
    ...
    <div class="dashboard-shell">
        ...
        <section class="display-hero">
            <div>
                ...
                <h4 class="hero-title">Dashboard Pencairan KIP-K Wilayah III</h4>
                <p class="hero-copy small mb-0">Pemantauan formal untuk total dana cair, jumlah pencairan, status proses, dan riwayat pengajuan terbaru.</p>
            </div>
        ...
        <section class="dashboard-command-strip">
            <a href="{!! url('pencairan-list') !!}" class="command-link" style="--command-color: #1b5b8f;">
                <span>
                    <span class="command-title">Verifikasi Pencairan</span>
                    <span class="command-subtitle">Kelola permohonan</span>
                </span>
                <span class="command-icon"><i class="ri-wallet-3-line"></i></span>
            </a>
            <a href="{!! url('pt-list') !!}" class="command-link" style="--command-color: #0ea5e9;">
                <span>
                    <span class="command-title">Perguruan Tinggi</span>
                    <span class="command-subtitle">Master institusi</span>
                </span>
                <span class="command-icon"><i class="ri-bank-line"></i></span>
            </a>
            <a href="{!! url('userpt-list') !!}" class="command-link" style="--command-color: #10b981;">
                <span>
                    <span class="command-title">User PT</span>
                    <span class="command-subtitle">Akun operator PT</span>
                </span>
                <span class="command-icon"><i class="ri-user-star-line"></i></span>
            </a>
            <a href="{!! url('laporan') !!}" class="command-link" style="--command-color: #f59e0b;">
                <span>
                    <span class="command-title">Laporan</span>
                    <span class="command-subtitle">Rekap pencairan</span>
                </span>
        ...
        <section class="metric-grid">
            <div class="metric-tile" style="--tile-color: #1b5b8f; --track-width: 72%;">
                ...
                <div class="metric-label small">Akumulasi dana tersalurkan</div>
            ...
            <div class="metric-tile" style="--tile-color: #2B79B4; --track-width: 86%;">
                ...
                <div class="metric-label small">Seluruh pengajuan tercatat</div>
                <div class="metric-track"><span></span></div>
            </div>
            ...
            <div class="metric-tile" style="--tile-color: #ef4444; --track-width: 78%;">
                <div class="metric-head">
                    <div>
            ...
            <div class="dashboard-panel">
                <div class="panel-header">
                    <div>
                        ...
                        <p class="panel-subtitle small mb-0">Rekap bulanan pengajuan pencairan KIP-K tahun berjalan.</p>
                    </div>
                </div>
            ...
            <div class="dashboard-panel">
                ...
                <div class="status-list">
                    <div class="status-item">
                        ...
                        <strong>{!! number_format($jumlah_pencairan) !!}</strong>
                    </div>
                    <div class="status-item">
        ...
        <section class="dashboard-grid mb-4">
            <div class="dashboard-panel">
                <div class="panel-header">
                    ...
                    <a href="{!! url('pencairan-list') !!}" class="panel-action">
                        ...
                        <tbody>
                            @forelse($pencairan_terbaru as $p)
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-semibold text-truncate" style="max-width: 170px;">{{ $p->perguruan_tinggi }}</div>
                                        <div class="activity-meta small">{{ $p->kode_pt }}</div>
                                    </td>
                                    <td>{{ $p->jenis_bantuan ?? 'Belum diset' }}</td>
                                    <td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-muted">Belum ada data pencairan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div class="dashboard-panel">
                <div class="panel-header">
                    <div>
                        ...
                        <p class="panel-subtitle small mb-0">Pengumuman terbaru untuk pengguna.</p>
                    </div>
                    <a href="{!! url('informasi-list') !!}" class="panel-action">Semua</a>
                </div>
                <div class="info-list pt-3">
                    @forelse($informasi->take(4) as $info)
                        <a href="{!! url('informasi-show/' . $info['id']) !!}" class="info-item">
                    ...
                    @empty
                        <div class="text-center py-4 text-muted">Belum ada informasi.</div>
                    @endforelse
                </div>
            </div>
        </section>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        new Chart(statusCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [{!! $jumlah_pencairan !!}, {!! $total_pencairan_proses !!}, {!! $total_pencairan_ditolak !!}],
